...
int64 nChainStartTime = 1435683501;
...
const string strMessageMagic = "tamagucci Signed Message:\n";
...
bool CBlock::ConnectBlock(CTxDB& txdb, CBlockIndex* pindex, bool fJustCheck)
{
    ...
    bool fEnforceBIP30 = true; // Always active in tamagucci
    bool fStrictPayToScriptHash = true; // Always active in tamagucci
...
bool CheckDiskSpace(uint64 nAdditionalBytes)
{
    ...
    if (nFreeBytesAvailable < nMinDiskSpace + nAdditionalBytes)
    {
        ...
        printf("*** %s\n", strMessage.c_str());
        uiInterface.ThreadSafeMessageBox(strMessage, "tamagucci", CClientUIInterface::OK | CClientUIInterface::ICON_EXCLAMATION | CClientUIInterface::MODAL);
        StartShutdown();
        return false;
    }
    return true;
...
bool LoadBlockIndex(bool fAllowNew)
{
    ...
    if (mapBlockIndex.empty())
    {
        ...
        // Genesis block
        const char* pszTimestamp = "July, 1st 2015. TamagucciCoin wallet launched";
        CTransaction txNew;
...
/**/
        ...
        assert(block.hashMerkleRoot == uint256("0x49cb677fb8db68c6d7c858f3b858410f4f1501b3d6bacd5a75d5a650037a31c9"));
...
unsigned char pchMessageStart[4] = { 0xde, 0xbb, 0xfa, 0xde };
